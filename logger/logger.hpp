...
namespace rmf
{
    ...
    constexpr std::array<std::string, 6> StringColors = {
        ...
        "\033[33m", "\033[34m", "\033[37m", "\033[90m", "\033[0m",
    };
    constexpr std::array<std::string, 6> LogLevelNames = {
        "\033[31m[Erro]", // Corresponds the the above loglevels
        "\033[33m[Warn]", "\033[34m[Info]", "\033[37m[Verb]",
        "\033[90m[Debu]", "\033[0m[How?]",
    };
    ...
    _LogWrapper Log(rmf_LogLevel level, const std::string_view file,
                    const std::string_view func, const size_t line);
}
